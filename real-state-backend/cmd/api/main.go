...
func main() {
	...
	protectedMux.HandleFunc("PUT /v1/properties/{id}", propHandler.UpdateProperty)
	protectedMux.HandleFunc("DELETE /v1/properties/{id}", propHandler.DeleteProperty)
	...
	protectedMux.HandleFunc("POST /v1/properties/{id}/media", propHandler.UploadPropertyMedia)
	protectedMux.HandleFunc("POST /v1/properties/{id}/main-image", propHandler.UploadPropertyMedia)
	// Backward compatibility (sin versión)
	protectedMux.HandleFunc("POST /properties/{id}/media", propHandler.UploadPropertyMedia)
	protectedMux.HandleFunc("POST /properties/{id}/main-image", propHandler.UploadPropertyMedia)
	// Backward compatibility (sin versión)
	...
	protectedMux.HandleFunc("PUT /properties/{id}", propHandler.UpdateProperty)
	protectedMux.HandleFunc("DELETE /properties/{id}", propHandler.DeleteProperty)
	...
	mux.Handle("PUT /v1/properties/{id}", protectedHandler)
	mux.Handle("DELETE /v1/properties/{id}", protectedHandler)
	...
	mux.Handle("PUT /properties/{id}", protectedHandler)
	mux.Handle("DELETE /properties/{id}", protectedHandler)
